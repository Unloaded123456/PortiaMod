...
public class BlockColored extends Block implements IBlockMetadata {
    ...
    public static final String[] names = { "white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "silver", "cyan", "purple", "blue", "brown", "green", "red", "black" };
}
